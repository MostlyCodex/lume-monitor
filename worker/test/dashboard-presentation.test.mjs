...
describe("dashboard presentation hierarchy", () => {
  it("keeps the fleet home focused on node cards and current network quality", () => {
    ...
    expect(styles).toContain("background: rgba(255, 255, 255, 0.014)");
    ...
    expect(glassRule).toContain("background: rgba(255, 255, 255, 0.0175)");
    expect(glassRule).toContain("backdrop-filter: blur(14px) saturate(108%)");
    expect(nodeCardRule).toContain("backdrop-filter: blur(14px) saturate(108%)");
    ...
    expect(styles).toContain('html[data-theme="light"] .scene::after { background: rgba(239, 245, 251, 0.06); }');
    expect(styles).toContain('html[data-theme="light"] .glass-panel { border-color: rgba(255, 255, 255, 0.09); background: rgba(255, 255, 255, 0.035);');
    expect(styles).toContain('html[data-theme="light"] .node-card { border-color: rgba(255, 255, 255, 0.09); background: rgba(255, 255, 255, 0.03);');
    ...
    expect(styles).toContain('html[data-theme="light"] .plot-tooltip { border-color: rgba(255, 255, 255, 0.09); background: rgba(255, 255, 255, 0.09);');
